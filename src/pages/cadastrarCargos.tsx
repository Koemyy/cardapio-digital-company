...
function CadastrarCargos() {
    ...
    return (
        <div>
            <HeaderEmpresa icon={<ArrowCircleLeft size={40} />} to="/home" />
            <div className="text-white-300 mx-5 my-4">
                <h1 className="text-3xl mb-4">Cadastrar cargos</h1>
                <p className="pb-4 font-extralight">Para conceder uma permissão clique no checkbox ao lado da opção desejada.</p>
                <form action="">
